...
<img src="{% asset_path posts/2014-12-15/vagrant.jpg %}" width="128" height="128" class="pull-right" alt="Vagrant logo" srcset="{% asset_path posts/2014-12-15/vagrant.jpg %} 1x, {% asset_path posts/2014-12-15/vagrant@2x.jpg %} 2x" style="max-width: 128px;">
...
<img src="{% asset_path posts/2014-12-15/chef.jpg %}" width="128" height="126" class="pull-right" alt="Chef logo" srcset="{% asset_path posts/2014-12-15/chef.jpg %} 1x, {% asset_path posts/2014-12-15/chef@2x.jpg %} 2x" style="max-width: 128px;">
